...
class SimpCarbfilmedExternalFilmCondensationTubeArrange(Carbfilm, ExternalFilmCondensationTubeArrange):
    ...
    def define_parameters(self):
        ...
        self.vbf0 = daeParameter("vbf0", m/s, self, "Fixed biofilm velocity")
        self.Tbf0 = daeParameter("Tbf0", K, self, "Fixed biofilm temperature")
